...
3. Read the MVP and Sprint documents.
4. Read `PROGRESS.md`.
5. Identify the current task.
6. Review the existing implementation.
7. Follow every rule in this document.
8. Build, test, verify, commit, update `PROGRESS.md`, and stop.

Any deviation from these instructions must be explicitly justified and documented.
