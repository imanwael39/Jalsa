...
export class NavigationService {
    ...
    private readonly allItems: NavItem[] = [
        ...
        { label: 'المساعد السريري الذكي', icon: 'bi-chat-dots', route: '/therapist-chat', roles: ['Therapist'] },
        { label: 'الدعم النفسي', icon: 'bi-chat-heart', route: '/support-chat', roles: ['Patient'] },
