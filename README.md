...
3. **Session Management** – notes, AI‑generated summaries.
...
- **Database**: SQL with pgvector for embeddings.
- **AI Services**: OpenAI (GPT‑4o, Vision), RAG (vector search).
- **Deployment**: Docker + Kubernetes / Azure App Service, GitHub Actions CI/CD.

##  Frontend Technology Stack
- **Framework**: Angular 17
- **Architecture**: Standalone components (no NgModules)
- **Language**: TypeScript (strict mode)
- **Styling**: SCSS + Bootstrap 5 with RTL support
- **State Management**: Angular Signals + RxJS services (no NgRx)
- **API Communication**: HttpClient with functional interceptors
(auth, error, loading)
