...
public class SessionCreateDtoValidator : AbstractValidator<SessionCreateDto>
{
    public SessionCreateDtoValidator()
    {
        ...
        RuleFor(x => x.SessionNote)
            .SetValidator(new SessionNoteCreateDtoValidator()!).When(x => x.SessionNote is not null);
    }
}

public class SessionNoteCreateDtoValidator : AbstractValidator<SessionNoteCreateDto>
{
    public SessionNoteCreateDtoValidator()
    {
